...
const PRODUCTS = [
  ...
  // Rice & Grains
  { id:'ri1',  name:"Ben's Original White Rice" },
  { id:'ri2',  name:'Minute Instant White Rice' },
  { id:'ri3',  name:'Goya Long Grain Rice' },
  { id:'ri4',  name:'Mahatma Jasmine Rice' },
  { id:'ri5',  name:'Lundberg Organic Brown Rice' },
  { id:'ri6',  name:'Near East Rice Pilaf' },
  { id:'ri7',  name:'Goya Yellow Rice Mix' },
  // Milk
  { id:'ml1',  name:'Horizon Organic 2% Milk' },
  { id:'ml2',  name:'Lactaid Whole Milk' },
  { id:'ml3',  name:'Organic Valley Whole Milk' },
  { id:'ml4',  name:'Hood Whole Milk' },
  { id:'ml5',  name:'Fairlife Whole Milk' },
  // Dairy additions
  { id:'da11', name:'Daisy Sour Cream' },
  { id:'da12', name:"Breakstone's Cottage Cheese" },
  { id:'da13', name:'Cabot Cheddar Block' },
  { id:'da14', name:'Sargento String Cheese' },
  { id:'da15', name:'Hood Heavy Whipping Cream' },
  { id:'da16', name:'Coffee-Mate Original Creamer' },
  { id:'da17', name:'Reddi Whip Original' },
  // Meat additions
  { id:'me6',  name:'Tyson Boneless Skinless Chicken Breasts' },
  { id:'me7',  name:'Perdue Chicken Breasts' },
  { id:'me8',  name:'Jennie-O Ground Turkey' },
  { id:'me9',  name:'Sabrett Hot Dogs' },
  // Produce
  { id:'pr1',  name:'Dole Classic Iceberg Salad' },
  { id:'pr2',  name:'Earthbound Farm Baby Spinach' },
  { id:'pr3',  name:'Dole Baby Carrots' },
  { id:'pr4',  name:'Taylor Farms Chopped Salad Kit' },
  { id:'pr5',  name:'Green Giant Broccoli Florets' },
  { id:'pr6',  name:'Del Monte Fresh Cut Green Beans' },
  // Frozen additions
  { id:'fr9',  name:'Tyson Chicken Nuggets' },
  { id:'fr10', name:'Green Giant Steamers Broccoli' },
  { id:'fr11', name:'Birds Eye Steamfresh Mixed Vegetables' },
  { id:'fr12', name:"Stouffer's Lasagna" },
  { id:'fr13', name:"Amy's Black Bean Burrito" },
  { id:'fr14', name:"Gorton's Fish Sticks" },
  { id:'fr15', name:'Hot Pockets Ham & Cheese' },
  { id:'fr16', name:'Bagel Bites Cheese & Pepperoni' },
  { id:'fr17', name:'Ling Ling Potstickers' },
  { id:'fr18', name:"Marie Callender's Chicken Pot Pie" },
  // Canned goods additions
  { id:'ca9',  name:'Goya Chickpeas' },
  { id:'ca10', name:'Goya Kidney Beans' },
  { id:'ca11', name:'Swanson Chicken Broth' },
  { id:'ca12', name:'Rotel Diced Tomatoes & Chilies' },
  // Condiments additions
  { id:'co11', name:'Goya Olive Oil' },
  { id:'co12', name:'Goya Sofrito' },
  { id:'co13', name:'Crisco Vegetable Oil' },
  { id:'co14', name:'Mazola Corn Oil' },
  { id:'co15', name:'Goya Sazon with Coriander' },
  { id:'co16', name:'Goya Adobo All Purpose' },
  { id:'co17', name:'La Choy Soy Sauce' },
  { id:'co18', name:'Wish-Bone Italian Dressing' },
  // Coffee additions
  { id:'cf6',  name:'Cafe Bustelo Espresso Ground' },
  { id:'cf7',  name:'Cafe Bustelo Instant Espresso' },
  // Soda & Water additions
  { id:'sw9',  name:'Sprite 12-Pack' },
  { id:'sw10', name:'7UP 12-Pack' },
  { id:'sw11', name:'Snapple Lemon Tea' },
  { id:'sw12', name:'Arizona Green Tea' },
  { id:'sw13', name:'Poland Spring Water Gallon' },
  { id:'sw14', name:'Poland Spring 24-Pack' },
  // Bread additions
  { id:'br6',  name:'Arnold Country White Bread' },
  { id:'br7',  name:'Pepperidge Farm Sandwich White Bread' },
  // Pasta additions
  { id:'pa7',  name:'Ronzoni Spaghetti' },
  { id:'pa8',  name:'Ronzoni Penne' },
  { id:'pa9',  name:'De Cecco Spaghetti' },
  // Bakery
  { id:'bk1e', name:"Entenmann's Chocolate Frosted Donuts" },
  { id:'bk2e', name:"Entenmann's Rich Frosted Donuts" },
  { id:'bk3e', name:"Entenmann's Crumb Coffee Cake" },
  { id:'bk4e', name:"Drake's Devil Dogs" },
  { id:'bk5e', name:"Drake's Ring Dings" },
  // Snack additions
  { id:'sn13', name:'Clif Bar Chocolate Chip' },
  { id:'sn14', name:'Quaker Chewy Granola Bars' },
  { id:'sn15', name:"Welch's Fruit Snacks" },
  // Household additions
  { id:'hw8',  name:'Febreze Air Freshener' },
  { id:'hw9',  name:'Ziploc Storage Bags Gallon' },
  { id:'hw10', name:'Reynolds Wrap Aluminum Foil' },
  { id:'hw11', name:'Clorox Regular Bleach' },
  { id:'hw12', name:'Pine-Sol Original' },
  { id:'hw13', name:'Cascade Complete Dishwasher Pods' },
  { id:'hw14', name:'Saran Premium Wrap' },
  { id:'hw15', name:'Dixie Everyday Plates' },
  { id:'hw16', name:'Hefty Strong Trash Bags' },
  // Personal care additions
  { id:'pc5',  name:'Pantene Pro-V Shampoo' },
  { id:'pc6',  name:'TRESemme Moisture Rich Shampoo' },
  { id:'pc7',  name:'Dove Body Wash' },
  { id:'pc8',  name:'Degree Original Deodorant' },
  { id:'pc9',  name:'Old Spice Deodorant' },
  { id:'pc10', name:'Secret Antiperspirant' },
  { id:'pc11', name:'Always Infinity Pads' },
  { id:'pc12', name:'Tampax Pearl Tampons' },
  { id:'pc13', name:'Gillette Mach3 Razors' },
  { id:'pc14', name:'Oral-B Toothbrush' },
  // Baby additions
  { id:'ba4',  name:'Pampers Baby Wipes' },
  { id:'ba5',  name:'Huggies Simply Clean Wipes' },
  { id:'ba6',  name:'Similac Advance Infant Formula' },
  { id:'ba7',  name:'Enfamil NeuroPro Infant Formula' },
];
